...
type SyncTopic struct {
	...
	Roman       string `protobuf:"bytes,2,opt,name=roman,proto3" json:"roman,omitempty"`
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
}

func (x *SyncTopic) Reset() {
	*x = SyncTopic{}
...
func (x *SyncTopic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncTopic) ProtoMessage() {}

func (x *SyncTopic) ProtoReflect() protoreflect.Message {
	mi := &file_proto_proto_proto_msgTypes[0]
...
// Deprecated: Use SyncTopic.ProtoReflect.Descriptor instead.
func (*SyncTopic) Descriptor() ([]byte, []int) {
	return file_proto_proto_proto_rawDescGZIP(), []int{0}
}

func (x *SyncTopic) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *SyncTopic) GetRoman() string {
	if x != nil {
		return x.Roman
	}
	return ""
...
func (x *SyncTopic) GetDescription() string {
	if x != nil {
...
var file_proto_proto_proto_rawDesc = []byte{
	...
	,
...
var file_proto_proto_proto_goTypes = []interface{}{
	(*SyncTopic)(nil), // 0: pub_sub.SyncTopic
	(*NoParam)(nil),   // 1: pub_sub.NoParam
}
var file_proto_proto_proto_depIdxs = []int32{
	0, // 0: pub_sub.Publisher.Send:input_type -> pub_sub.SyncTopic
	1, // 1: pub_sub.Publisher.Send:output_type -> pub_sub.NoParam
